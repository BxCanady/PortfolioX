  ...
  >
    <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
      <div className="flex flex-col justify-center h-full">
        ...
        I realized that scalability was not just a technical challenge ~ but a mindset.<br></br>
        My journey as a <strong>Software Developer</strong> has been a testament to the power of perseverance and the thrill of innovation.
        </p>
