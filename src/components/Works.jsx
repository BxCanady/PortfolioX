    ...
    <div name="work" className="w-full h-screen bg-[#0a192f] text-gray-300">
      {showComingSoon ? ( // Conditionally render the ComingSoon component
        ...
        <div className="max-w-[1000px] mx-auto p-4">
          <div className="pb-8 w-full fluseEffectex justify-center items-center flex-col">
            ...
            <p className="py-6 text-1xl text-blue-400">
              (:hover to get a glimpse)
            </p>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            >
              <div className="absolute inset-0 flex justify-center items-center flex-col opacity-0 group-hover:opacity-100 z-20 ">
                <p className="text-center font-bold text-lg text-green-400">
                  Ecommerce Site built with Next.js, Shopify & Stripe API
                </p>
                <div className="pt-8 text-center">
                  <a
                    href="https://www.socialstatuspgh.com"
                    target="_blank"
              ...
              <div
                className="absolute inset-0 rounded-md flex bg-auto bg-center opacity-0 group-hover:opacity-100 z-20"
                style={{
                  backgroundImage: `url(${socialapp})`,
            ...
            >
              <div className=" inset-0 flex justify-center items-center flex-col opacity-0 group-hover:opacity-100 z-10">
                <p className="text-center font-bold text-lg text-green-400">
                  Typescript Inventory Management App
                </p>
                <p className="text-center font-bold text-lg text-green-400">
                  Built with Refine framework for CRUD-heavy web applications
                </p>
                <div className="pt-8 text-center">
                  <button
                    className="animate-pulse group text-white px-4 py-3 m-2 rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer"
              ...
              <div
                className="absolute inset-0 rounded-md flex bg-auto bg-center opacity-0 group-hover:opacity-100 z=1"
                style={{
            ...
            <div
              style={{
                backgroundImage: !isStacked ? `url(${awsp})` : `url(${docman})`,
              }}
            ...
            >
              <div className="absolute inset-0 flex justify-center items-center flex-col opacity-0 group-hover:opacity-100 z-10">
                <p className="text-center font-bold text-lg text-green-400">
                  Python document reformatter chart visualizer built with
                  Posgres, AWS Amplify & Lambda and React for frontend
                </p>
                <div className="pt-8 text-center">
                  <button
                    className="animate-pulse group text-white px-4 py-3 m-2 rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer"
              ...
              <div
                className="absolute inset-0 rounded-md flex bg-auto bg-center opacity-0 group-hover:opacity-100 "
                style={{
                  backgroundImage: `url(${docman})`,
                  backgroundSize: "contain",
                  backgroundRepeat: "no-repeat",
                  marginTop: "-525px",
                }}
